      ...
      >
        ...
        <div className="w-full md:w-1/2 h-full flex flex-col bg-white px-4 py-5 md:pr-10 overflow-hidden">
          ...
          <motion.div 
            ...
            className="w-full md:w-[90%] min-h-64 max-h-[50%] mx-auto mt-10 md:mt-auto rounded-3xl overflow-hidden"
          >
            <img
        ...
        >
          ...
          <motion.p 
            ...
            className="text-white/70 text-sm px-5 mt-6 md:mt-auto leading-relaxed z-10 w-full md:w-1/2"
          >
